...
const AdminSidebar = () => {
    ...
    const menus = [
        ...
        { name: "Post Management", link: "productmanagement", icon: MdProductionQuantityLimits, margin: true },
        { name: "Logout", link: "categorymanagement", icon: MdOutlineCategory, margin: true },
  ...
  return (
   ...
   <section className="flex gap-">
      ...
      <div
        className={`bg-[#2A2A2A] min-h-screen  ${
          open ? "md:w-72" : "w-16"
