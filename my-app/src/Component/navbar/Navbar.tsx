                            ...
                            <div className='flex space-x-7'>
                                ...
                                <div className='text-white '>
                                    ...
                                    <Menu as="div" className="relative inline-block text-left">
                                        ...
                                        >
                                            <Menu.Items className="absolute right-0 z-10 mt-2 w-44  origin-top-right rounded-lg bg-[#474242] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                <div className="py-1">
                                                    <Menu.Item>
                                                        {({ active }) => (
                                                            <div
