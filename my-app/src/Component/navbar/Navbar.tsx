...
const Navbar = () => {
    ...
    return (
        ...
        {/* LARGE_SCREEN */}
            <nav className="hidden md:block relative  flex-wrap items-center justify-between px-10 py-4 bg-[#1A1A1A] mb-3">
                <div className="container px-4 mx-auto  items-center justify-between grid grid-cols-3 gap-4">
                    <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start ">
                        <a
                            className=" font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white cursor-pointer text-lg">
                            See Chat
                    ...
                    <div className='flex xl:space-x-20 xl:pl-10 md:space-x-12 md:pl- lg:pl-'>
                      ...
                      <div className='text-white text-lg gap-2 '><Link to="/"><CgProfile size={28}/></Link></div>
                    </div>
                    <div className='text-white text-end'>Hello</div>
                </div>
            </nav>
